...
import 'package:ozone_erp/screens/receiptvoucher/controller/receipt_voucher_controller.dart';
...
class ReceiptVoucherScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(title: 'Receipt Voucher', centerTitle: true),
      drawer: const CustomMenu(),
      body: const ReceiptVoucherView(),
    );
  }
}

class ReceiptVoucherView extends GetView<ReceiptVoucherController> {
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                Row(
                  children: [
                    Expanded(flex: 1, child: Text('From Account:')),
                    Expanded(
                      flex: 2,
                          ...
                          return CustomTextField(
                              ...
                              validator: (value) {
                                final receiptController =
                                    Get.find<ReceiptVoucherController>();
                                if (value!.trim().isEmpty) {
                                  return 'From Account Required';
                                } else if (receiptController
                    ...
                    return controller.selectedCustomer.value.creditAmount ==
                        ...
                        : Row(
                            children: [
                              ...
                              Expanded(
                                  child: Text(
                                      '${controller.selectedCustomer.value.creditAmount ?? '0'} Dr')),
                            ],
                          );
                  },
                ),
