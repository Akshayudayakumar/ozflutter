...
class SalesButtonsRow extends GetView<NewSaleController> {
  const SalesButtonsRow({super.key});
          ...
          child: PrintButton(
            onTap: () async {
              ...
              if (controller.payableAmount.text.isEmpty ||
                ...
                Utils().showToast('Received Amount cannot be zero');
                return;
              }
              if (double.parse(controller.payableAmount.text) >
                  controller.grandTotal.value) {
                Utils().showToast(
                    'Received Amount cannot be greater than Grand Total');
                return;
              }
